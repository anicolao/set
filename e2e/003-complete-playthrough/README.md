...
**Verifications**:
- [x] Player 1 found a set: 2-squiggle-purple-open, 1-pill-purple-open, 3-diamond-purple-open
- [x] Cards were removed/replaced
...
**Screenshot**: `009-turn-6-complete.png`
...
**Verifications**:
- [x] Player 1 found a set: 2-pill-purple-solid, 3-pill-red-striped, 1-pill-green-open
- [x] Cards were removed/replaced
...
**Screenshot**: `018-turn-15-complete.png`
...
**Screenshot**: `022-turn-19-complete.png`
